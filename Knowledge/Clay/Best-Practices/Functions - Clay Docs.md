---
title: "Functions - Clay Docs"
source: "https://university.clay.com/docs/functions"
author:
published:
created: 2026-07-14
description: "Functions let you convert any enrichment sequence into a reusable workflow. Once created, you can use it across any table — and any updates you make to the function automatically apply everywhere it's used."
tags:
  - "clippings"
---
Overview
...
Table of contents[What functions are for](#what-functions-are-for)[Creating a function](#creating-a-function)[Calling a function from a table](#calling-a-function-from-a-table)[Editing a function](#editing-a-function)[Managing MCP access and credit budgets](#managing-mcp-access-and-credit-budgets)

[

FAQs

](#faqs)[What plans are functions available on?](#what-plans-are-functions-available-on)[Does running a function cost extra credits?](#does-running-a-function-cost-extra-credits)[Is there a row limit for functions?](#is-there-a-row-limit-for-functions)[What's the difference between an input and a column in a function?](#whats-the-difference-between-an-input-and-a-column-in-a-function)[Why can't I run/edit a function in "Live" mode directly?](#why-cant-i-runedit-a-function-in-live-mode-directly)[Can functions call other functions?](#can-functions-call-other-functions)[What happens if I edit a function while it's running in a production table?](#what-happens-if-i-edit-a-function-while-its-running-in-a-production-table)[How are functions different from column templates?](#how-are-functions-different-from-column-templates)[Is there version history for functions?](#is-there-version-history-for-functions)[What is the main use case for functions?](#what-is-the-main-use-case-for-functions)[Does saving columns as a function rerun those columns and consume credits?](#does-saving-columns-as-a-function-rerun-those-columns-and-consume-credits)[Can I use a function someone else on my team built?](#can-i-use-a-function-someone-else-on-my-team-built)[What is the difference between editing a function and pausing a function?](#what-is-the-difference-between-editing-a-function-and-pausing-a-function)[If I edit a function while it's live, will rows that already ran show as stale?](#if-i-edit-a-function-while-its-live-will-rows-that-already-ran-show-as-stale)[What columns should I include when building a function?](#what-columns-should-i-include-when-building-a-function)[Can I share a function with someone outside my workspace?](#can-i-share-a-function-with-someone-outside-my-workspace)[Can a function be enabled for MCP tools like ChatGPT or Claude?](#can-a-function-be-enabled-for-mcp-tools-like-chatgpt-or-claude)[How can I limit who can edit my functions?](#how-can-i-limit-who-can-edit-my-functions)[How do I debug specific rows while editing a function?](#how-do-i-debug-specific-rows-while-editing-a-function)