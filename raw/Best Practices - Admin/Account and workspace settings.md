...
source: "https://university.clay.com/docs/workspace-administration-documentation"
author:
published:
created: 2026-07-14
...
- Click `Change password`. A magic link will be sent to your registered email address.
	- *Note: This option is available only if you signed in using a password and not via an authentication service such as Google or SSO.*
