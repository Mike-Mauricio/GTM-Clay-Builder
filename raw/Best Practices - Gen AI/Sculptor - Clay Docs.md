---
title: "Sculptor - Clay Docs"
source: "https://university.clay.com/docs/sculptor"
author:
published:
created: 2026-07-14
...
3. **Iterate and review.** Sculptor will propose a workflow with integrations, enrichments, and conditions.
	- You can reply directly in the chat to adjust or refine the table instantly.
		- When suggesting changes to an existing table, Sculptor automatically brings you into [**Sandbox mode**](https://university.clay.com/docs/sandbox-mode) first so you can test changes without affecting your production workflow.
...
- **Table modifications use sandbox mode** — When suggesting changes to existing tables, Sculptor brings you into Sandbox mode automatically. You can test changes safely before publishing them to your production table.
