...
source: "https://university.clay.com/docs/work-email-waterfall"
author:
published:
created: 2026-07-14
description: "Find and validate work emails faster — the Work Email waterfall cascades across multiple providers in sequence, stopping as soon as a valid result is found."
tags:
  - "clippings"
---
Overview
...
No. `Infer Email` is completely free. The validation step *does* cost Clay credits, but it is cheaper than running the waterfall without it.
