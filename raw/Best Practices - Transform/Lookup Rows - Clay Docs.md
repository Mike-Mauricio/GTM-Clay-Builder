---
title: "Lookup Rows - Clay Docs"
source: "https://university.clay.com/docs/lookup-rows"
author:
published:
created: 2026-07-14
...
<iframe src="https://www.loom.com/embed/89162557968c424b8bdc91eeb85ab5b6" frameborder="0" allowfullscreen=""></iframe>
1. Identify a shared value to compare between the two tables (e.g., company URL, email address, or other value two rows might share).
2. Normalize your key if needed (e.g. extract the domain from an email into a `Domain` column).
...
<iframe src="https://www.loom.com/embed/88d926193a08451fb5c0098b008b0585" frameborder="0" allowfullscreen=""></iframe>
